...
use addons\Warehouse\common\forms\WarehousePartsBillCGoodsForm;
 ...
 * 领件单
 */
class PartsBillCGoodsController extends PartsBillGoodsController
{
    use Curd;
    public $modelClass = WarehousePartsBillCGoodsForm::class;
    ...
    public function actionIndex()
    {
        ...
        $returnUrl = \Yii::$app->request->get('returnUrl',Url::to(['parts-bill-c-goods/index', 'bill_id'=>$bill_id]));
