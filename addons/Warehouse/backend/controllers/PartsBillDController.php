...
use addons\Warehouse\common\forms\WarehousePartsBillDForm;
...
/**
 * PartsBillDController implements the CRUD actions for StyleChannel model.
 */
class PartsBillDController extends PartsBillController
{
    use Curd;
    public $modelClass = WarehousePartsBillDForm::class;
    ...
    public function actionView()
    {
        ...
        $returnUrl = Yii::$app->request->get('returnUrl',Url::to(['parts-bill-d/index', 'bill_id'=>$bill_id]));
    ...
    private function getData($ids){
        ...
        $query = WarehousePartsBillDForm::find()->alias('w')
