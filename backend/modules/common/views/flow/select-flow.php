...
<div class="row">
    <div class="col-xs-12">
        ...
        <div class="form-group field-ring-ring_flow">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (parseInt(data.code) !== 200) {
                        ...
                        var tr = $("<tr>"
                            +"<td>" + data.id + "</td>"
                            +"<td>" + data.flow_name + "</td>"
                            +"<td>" + data.flow_status + "</td>"
                            +'<td><a class="btn btn-danger btn-sm deltr" href="#" data-flowId="'+data.id+'">删除</a></td>'
                            + "</tr>");
